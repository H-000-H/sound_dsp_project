...
void MusicApp::build_ui()
{
    ...
    lv_obj_set_style_bg_color(m_screen, lv_color_hex(0x0E0F14), 0);
    ...
    /* ——— 黑胶唱片 ——— */
    {
        ...
        lv_obj_set_style_bg_color(base, lv_color_hex(0x1C1C22), 0);
        lv_obj_set_style_bg_opa(base, LV_OPA_COVER, 0);
        lv_obj_set_style_border_width(base, 1, 0);
        lv_obj_set_style_border_color(base, lv_color_hex(0x2C2F3E), 0);
        ...
        lv_obj_set_style_border_color(ring1, lv_color_hex(0x3A3D4E), 0);
        ...
        lv_obj_set_style_border_color(ring2, lv_color_hex(0x3A3D4E), 0);
        ...
        lv_obj_center(dot);
        lv_obj_set_style_bg_color(dot, lv_color_hex(0xFF9F0A), 0);
    ...
    /* ——— 歌曲信息 ——— */
    {
        ...
        lv_obj_set_style_text_color(m_title, lv_color_hex(0xF5F5F7), 0);
        ...
        lv_obj_set_style_text_color(m_artist, lv_color_hex(0x8E8E93), 0);
    ...
    /* ——— 音效下拉 ——— */
    {
        ...
        lv_obj_set_size(m_mode_dd, 136, 28);
        ...
        lv_obj_set_style_bg_color(m_mode_dd, lv_color_hex(0x1C1C22), 0);
        lv_obj_set_style_bg_opa(m_mode_dd, LV_OPA_COVER, 0);
        lv_obj_set_style_border_width(m_mode_dd, 1, 0);
        lv_obj_set_style_border_color(m_mode_dd, lv_color_hex(0x3A3D4E), 0);
        ...
        lv_obj_set_style_text_color(m_mode_val, lv_color_hex(0xF5F5F7), 0);
    ...
    /* ——— 进度条 ——— */
    {
        ...
        lv_obj_set_style_bg_color(track, lv_color_hex(0x2C2F3E), 0);
        ...
        lv_obj_set_style_bg_color(m_prog_bar, lv_color_hex(0xFF9F0A), LV_PART_INDICATOR);
        ...
        lv_obj_set_style_bg_color(m_prog_knob, lv_color_hex(0xFF9F0A), 0);
        ...
        lv_obj_set_style_shadow_color(m_prog_knob, lv_color_hex(0xFF9F0A), 0);
        lv_obj_set_style_shadow_opa(m_prog_knob, LV_OPA_40, 0);

        m_time_l = lv_label_create(m_screen);
        lv_obj_set_style_text_color(m_time_l, lv_color_hex(0x5C5F73), 0);
        ...
        lv_obj_set_style_text_color(m_time_r, lv_color_hex(0x5C5F73), 0);
    ...
    /* ——— 音量条 ——— */
    {
        ...
        lv_obj_set_style_bg_color(m_vol_bar, lv_color_hex(0x2C2F3E), LV_PART_MAIN);
        ...
        lv_obj_set_style_bg_color(m_vol_bar, lv_color_hex(0xFF9F0A), LV_PART_INDICATOR);
        ...
        lv_obj_set_style_text_color(vlbl, lv_color_hex(0x8E8E93), 0);
    ...
    /* ——— 播放控制 ——— */
    {
        ...
        lv_obj_set_style_bg_color(prev, lv_color_hex(0x1C1C22), 0);
        lv_obj_set_style_bg_opa(prev, LV_OPA_COVER, 0);
        lv_obj_set_style_border_width(prev, 1, 0);
        lv_obj_set_style_border_color(prev, lv_color_hex(0x2C2F3E), 0);
        ...
        lv_obj_set_style_text_color(pi, lv_color_hex(0xF5F5F7), 0);
        ...
        lv_obj_set_style_bg_color(m_play_btn, lv_color_hex(0x1C1C22), 0);
        lv_obj_set_style_bg_opa(m_play_btn, LV_OPA_COVER, 0);
        lv_obj_set_style_border_width(m_play_btn, 2, 0);
        lv_obj_set_style_border_color(m_play_btn, lv_color_hex(0x5C5F73), 0);
        ...
        lv_obj_set_style_bg_color(next, lv_color_hex(0x1C1C22), 0);
        lv_obj_set_style_bg_opa(next, LV_OPA_COVER, 0);
        lv_obj_set_style_border_width(next, 1, 0);
        lv_obj_set_style_border_color(next, lv_color_hex(0x2C2F3E), 0);
        ...
        lv_obj_set_style_text_color(ni, lv_color_hex(0xF5F5F7), 0);
        ...
        lv_obj_set_style_text_color(m_play_mode_lbl, lv_color_hex(0x8E8E93), 0);
...
void MusicApp::focus_update()
{
    ...
    reset(m_record, 1, lv_color_hex(0x2C2F3E), lv_color_hex(0x1C1C22));
    if (m_prog_knob) {
        lv_obj_set_style_border_width(m_prog_knob, 0, 0);
        lv_obj_set_style_shadow_width(m_prog_knob, 6, 0);
        lv_obj_set_style_shadow_color(m_prog_knob, lv_color_hex(0xFF9F0A), 0);
    ...
    reset(m_mode_dd, 1, lv_color_hex(0x2C2F3E), lv_color_hex(0x1C1C22));
    if (m_play_mode_lbl)
        lv_obj_set_style_text_color(m_play_mode_lbl, lv_color_hex(0x8E8E93), 0);

    uint32_t bw = 3;
    lv_color_t accent = m_adjust ? lv_color_hex(0xFFFFFF) : lv_color_hex(0xFF9F0A);
    lv_color_t highlight = m_adjust ? lv_color_hex(0x2C2F3E) : lv_color_hex(0x1E202A);
...
void MusicApp::update_display()
{
    ...
    if (m_play_btn) {
        ...
        if (m_playing) {
            lv_obj_set_style_bg_color(m_play_btn, lv_color_hex(0xFF9F0A), 0);
...
void MusicApp::handle_key(uint32_t key)
{
    ...
    if (key == LV_KEY_ESC) {
        if (m_adjust) { m_adjust = false; focus_update(); }
        else { lv_async_call([](void*) { card_menu_show(); }, nullptr); }
        return;
    }

    if (m_adjust) {
        if (m_focus == FOCUS_PLAY_CTRL) {
            if (key == LV_KEY_ENTER) { m_playing = !m_playing; on_play_pause(); update_display(); }
            else if (key == LV_KEY_NEXT) { on_next(); update_display(); }
            else if (key == LV_KEY_PREV) { on_prev(); update_display(); }
            return;
        }
        if (key == LV_KEY_ENTER) { m_adjust = false; focus_update(); return; }

        switch (m_focus) {
        case FOCUS_PROGRESS:
            if (key == LV_KEY_NEXT) { m_progress = m_progress + 5 > 100 ? 100 : m_progress + 5; on_seek(m_progress); update_display(); }
            else if (key == LV_KEY_PREV) { m_progress = m_progress < 5 ? 0 : m_progress - 5; on_seek(m_progress); update_display(); }
            break;
        case FOCUS_PLAY_MODE:
            if (key == LV_KEY_NEXT) { m_play_mode = (m_play_mode + 1) % 3; update_display(); }
            else if (key == LV_KEY_PREV) { m_play_mode = (m_play_mode + 2) % 3; update_display(); }
            break;
        case FOCUS_AUDIO_MODE:
            if (key == LV_KEY_NEXT) { m_audio_mode = (m_audio_mode + 1) % 4; update_display(); }
            else if (key == LV_KEY_PREV) { m_audio_mode = (m_audio_mode + 3) % 4; update_display(); }
            break;
        default: break;
        }
    } else {
        if (key == LV_KEY_ENTER) {
            ...
            } else { m_adjust = true; focus_update(); }
        } else if (key == LV_KEY_NEXT) { m_focus = (m_focus + 1) % FOCUS_COUNT; focus_update(); }
        else if (key == LV_KEY_PREV) { m_focus = (m_focus + FOCUS_COUNT - 1) % FOCUS_COUNT; focus_update(); }
    }
}
...
void music_nav_timer_cb(lv_timer_t* t)
{
    ...
    if (lv_screen_active() != app->screen()) { app->m_nav_held = false; return; }
...
void MusicApp::hide()
{
    if (m_prog_timer) { lv_timer_delete(m_prog_timer); m_prog_timer = nullptr; }
    if (m_nav_timer)  { lv_timer_delete(m_nav_timer);  m_nav_timer  = nullptr; }
}
